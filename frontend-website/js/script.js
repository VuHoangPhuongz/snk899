...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- Rèm/Màn ngăn cháy ---
    {
        ...
        sku: 'RNC-01',
        images: ['./anh/man ngan chay 1 lop.jpg', './anh/ie 90.jpg', './anh/ie 60 test.jpg'],
    ...
    },
    {
        ...
        category: 'Rèm/Màn cuốn ngăn cháy',
        sku: 'RNC-02',
        images: ['./anh/ie 90.jpg', './anh/man ngan chay 1 lop.jpg', './anh/ie 60 test.jpg'],
    ...
    },
    {
        ...
        category: 'Rèm/Màn cuốn ngăn cháy',
        sku: 'RNC-03',
        images: ['./anh/ie 60 test.jpg', './anh/man ngan chay 1 lop.jpg', './anh/ie 90.jpg'],
    ...
    // --- Tấm Panel ---
    {
        ...
        sku: 'PNL-01',
        images: ['./anh/panel-loi-xop-thuong-day-10-cm_300x300.jpg'],
    ...
    },
    {
        ...
        category: 'Tấm Panel chống cháy',
        sku: 'PNL-02',
        images: ['./anh/panel-loi-bong-khoang-day-100-mm_300x300.jpg'],
    ...
    },
    {
        ...
        category: 'Tấm Panel chống cháy',
        sku: 'PNL-03',
        images: ['./anh/panel-mai-loi-bong-khoang-rockwool_300x300.jpg'],
    ...
    // --- Ron Chống Cháy ---
    {
        ...
        sku: 'RON-01',
        images: ['./anh/ron-chong-chay-cua-thep_300x300.png'],
    ...
    },
    {
        ...
        category: 'Ron chống cháy',
        sku: 'RON-02',
        images: ['./anh/ron-chong-chay-thanh_300x300.png'],
    ...
    },
    {
        ...
        category: 'Ron chống cháy',
        sku: 'RON-03',
        images: ['./anh/ron-chong-chay-mem_300x300.png'],
    ...
    // ===================================================================
    // STATE MANAGEMENT (Giỏ hàng và trang hiện tại)
    // ===================================================================
    ...
    document.body.addEventListener('click', function(event) {
        ...
        if (categoryLink) {
             event.preventDefault();
             const filter = categoryLink.dataset.filter;
    ...
    function renderProductDetail(productId) {
        ...
        gallery.innerHTML = product.images.map((imgSrc, index) => `
            <div class="aspect-square border rounded hover:border-green-primary cursor-pointer p-1 ${index === 0 ? 'border-2 border-green-primary' : ''}" onclick="document.getElementById('product-detail-image').src='${imgSrc}'">
                <img src="${imgSrc}" class="w-full h-full object-cover rounded-sm">
            </div>
        `).join('');
    ...
    function filterProducts(category) {
        ...
        document.querySelectorAll('#product-grid .product-card').forEach(product => {
    ...
    function addToCart(productId) {
        ...
        saveCart();
        updateCartUI();
        toggleCart(true); // Open cart sidebar after adding
    }
    ...
    function updateCartUI() {
        ...
        // Since prices are "Liên hệ", subtotal is not calculated.
